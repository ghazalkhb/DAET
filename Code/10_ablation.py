...
#
# This historical script requires per-step `mozilla_results*.csv` files and
# intermediate vectors from the calibration pipeline. Frozen outputs are
# included, but not all historical intermediate vectors are distributed.
#
...
# ──────────────────────────────────────────────────────────────────────────────
# Baseline parameters (must match the frozen calibration outputs)
# ──────────────────────────────────────────────────────────────────────────────
DEFAULT_BETA        = 0.30
...
print("=" * 60)
print("\nSee ARTIFACT_MANIFEST.md before interpreting these calibration outputs.")
